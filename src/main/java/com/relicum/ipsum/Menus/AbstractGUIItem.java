...
/**
 * AbstractGUIItem implements most of the {@link GenericMenuItem} methods. But
 * some still need to be defined. All menu items should extend off this class.
 *
 * @author Relicum
 * @version 0.0.1
 */
@ToString
public abstract class AbstractGUIItem implements GenericMenuItem {
    ...
    @Getter
    @Setter
    protected boolean costRequired = false;
     ...
     */
    public AbstractGUIItem(Material itemMaterial, byte dataBit, int itemAmount, MetaType metaType) {
     ...
     * @param metaType the {@link com.relicum.ipsum.Items.MetaType}
     */
    public AbstractGUIItem(Material itemMaterial, int itemAmount, MetaType metaType) {
        this.itemMaterial = itemMaterial;
